    ...
    <section class="prime">
        <div class="container">
            <div class="row">
                ...
                <div class="number">
                    <div class="int">2014</div>
                    <div class="text">год сдачи первых
                        <br> домов в 38 микрорайоне</div>
                </div>
                <div class="number">
                    <div class="int">2800</div>
                    <div class="text">машиномест в двухуровневом подземном паркинге</div>
                </div>
                <div class="number">
                    <div class="int">5000</div>
                    <div class="text">квартир уже продано, осталось менее 1000 квартир</div>
                </div>
            </div>
        </div>
    </section>
...
до 40%
                ...
                <div class="icon--romb">
                    ...
                    <h3>Ремонт квартир <br>от 1,2 тыс.руб./м2 <br>включается в ипотеку
        ...
        <div class="container">
            <div class="row">
                <div class="text">
                    ...
                    <p class="subhead"><span>Более 5000 семей уже купили квартиры в 38 мкр.</span>
    ...
    <section class="photos">
        <div class="container ">
            ...
            <div class="photogalery">
                <div class="row ">
                    <a href="/big/1/sps6.jpg" title="">
                        <img src="/images/sps6.png" alt="" class="img">
                    </a>
                    <a href="big/1/IMG_9002.jpg" title="">
                        <img src="/images/IMG_9002.png" alt="" title="" class="img">
                    </a>
                    <a href="big/1/IMG_9008.jpg" title="">
                        <img src="/images/IMG_9008.png" alt="" class="img">
                    </a>
                    <a href="big/1/house.jpg" title="">
                        <img src="/images/foto4.png" alt="" class="img">
                    </a>
                    <a href="big/1/divan.jpg" title="">
                        <img src="/images/foto5.png" alt="" class="img">
                    </a>
                </div>
                <div class="row">
                    <a href="/big/1/sps6.jpg" title="">
