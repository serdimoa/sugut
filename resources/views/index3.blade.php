...
<body>
    ...
    <section class="baner" style="background: url(/images/background-3.jpg);background-position: 0 0;
                    ...
                    <div class="row">
                        <div class="good__list">
                            <ul>
                                ...
                                <li>Квартиры от 27 до 97 м&#178;</li>
                                <li>Безопасные детские площадки</li>
                                <li>Школа - детский сад</li>
    ...
    <section class="prime">
        <div class="container">
            <div class="row">
                ...
                <div class="number">
                    <div class="int">11</div>
                    <div class="text">видов различных
                        <br>планировок</div>
                </div>
                <div class="number">
                    <div class="int">2015</div>
                    <div class="text">год сдачи домов
                        <br> дома на ул. Мелик-Карамова</div>
                </div>
                <div class="number">
                    <div class="int">557</div>
                    <div class="text">машиномест в подземном паркинге</div>
                </div>
                <div class="number">
                    <div class="int">500</div>
...
покупателям</div>
    ...
    <section id="about__micro" class="about__micro">
        <div class="container">
            <div class="row">
                <div class="images">
                    <img src="/images/rombs.jpg" class="img-responsive" alt="">
...
<b>по ул. Мелик-Карамова 40, 40/1</b></h2>
              ...
              alt=""></span>                  
                    ...
                    <p>Жилье в этих домах компании «Сибпромстрой» привлекательно тем, что здесь располагаются квартиры свободной планировки. К примеру, есть двухкомнатные квартиры с кухней-нишей. Планировочные решения обусловлены ориентацией дома по сторонам света с учетом естественной освещенности жилых помещений, а также потребительским спросом.
Из окон верхних этажей открывается потрясающий вид как на весь город, так и на реку Обь. Благодаря близкому расположению к реке летние прогулки будут жильцам, конечно же, в радость.</p>
    ...
    <section class="enes">
        <div class="container">
            <div class="row">
                <div class="enes__logo">
                    <img src="/images/logo-enes20113.png" alt="">
                </div>
    ...
    <section class="infrostructure">
        <div class="container">
            <div class="row">
                ...
                <p class="sub">Рядом сразу несколько детских садов, школ и медицинских учреждений.  Есть магазины, банки —  все необходимое для комфортного проживания. Оборудованы игровые комплексы для самых маленьких, баскетбольная площадка и турники для тех, кто постарше. Двор благоустроен: высажены деревья и газонная трава.</p>
            </div>
            <div class="row">
                <div class="icon__blue blue">
...
до 40%
                    ...
                    <p>- Энергоэффективные дома
                        ...
                        <br> пользования, нет подвалов и чердаков <br>- Бойлерная система горячего водоснабжения делает Вас
        ...
        <div class="container">
            <div class="row">
                <div class="text">
                    ...
                    <p class="subhead"><span>500 квартир доступно для продажи по адресу ул. Мелик-Карамова, 40, 40/1</span>
            ...
            <div class="photogalery">
                <div class="row ">
                    <a href="/big/2/sps6.jpg" title="">
                        <img src="images/31.png" alt="" class="img"> 
                        
                    </a>
                    <a href="big/2/IMG_9002.jpg" title="">
                        <img src="images/32.png" alt="" title="" class="img">     
                        
                    </a>
                    <a href="big/2/IMG_9008.jpg" title="">
                        <img src="images/33.png" alt="" class="img">                     
                        
                        
                    </a>
                    <a href="big/2/house.jpg" title="">
                        <img src="images/34.png" alt="" class="img">
                        
                        
                    </a>
                    <a href="big/2/divan.jpg" title="">
                        <img src="images/35.png" alt="" class="img">                        
                        
                    </a>
                </div>
                <div class="row">
                    <a href="/big/2/sps6.jpg" title="">
                        <img src="images/36.png" alt="" class="img">
                        
                        
                    </a>
                    <a href="big/2/IMG_9002.jpg" title="">
                        <img src="images/37.png" alt="" title="" class="img">
                        
                        
                    </a>
                    <a href="big/2/IMG_9008.jpg" title="">
                        <img src="images/38.png" alt="" class="img">
                        
                        
                    </a>
                    <a href="big/2/house.jpg" title="">
                        <img src="images/39.png" alt="" class="img">
                        
                        
                    </a>
                    <a href="big/2/divan.jpg" title="">
                        <img src="images/310.png" alt="" class="img">
