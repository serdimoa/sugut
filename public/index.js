...
*/
    ...
    $('.reed__more--content').hide();
    if($('.read__more'))

        $('#reeds').click(
          function (e) {
              e.preventDefault();
              $('.reed__more--content').toggle('slow');
          }
        );
    ...
    $('.Forms').submit(function (e) {
        ...
        if (checkActive()) {
            var url = "/header_form";
            var $post = {};
            $post.form_name=$(this).find($(".form__name--input")).val();
            $post.page=window.location.href;
            $post.name = $(this).find($('.name--input')).val();
            $post.phone = $(this).find($('.phone--input')).val();
